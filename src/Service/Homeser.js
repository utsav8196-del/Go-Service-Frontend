                ...
                <div className="container text-center py-5">
                    ...
                    <nav aria-label="breadcrumb animated slideInDown">
                        <ol className="breadcrumb justify-content-center mb-0">
                            ...
                            <li className="breadcrumb-item text-primary active" aria-current="page">Home Clening</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div className="container">
                        <div className="row gy-4 justify-content-center">
                            <div className="col-lg-4">
                                <img src="img/home-clean.jpeg" className="img-fluid" alt="Home-Clen" />
                            </div>
                            <div className="col-lg-5 content">
                                ...
                                <div className="row">
                                    <div className="col-lg-6">
                                        <ul>
                                            <li><i className="bi bi-chevron-right" /> <strong>Type:</strong> <span>Home Cleaner</span></li>
            ...
            <section id="recent-blog-posts" className="recent-blog-posts">
                <div className="container" data-aos="fade-up">
                    ...
                    <div className="row gy-5">
                        ...
                        <Link className="small" to="/Clients">
                            <div className="post-item position-relative h-100">
                                <div className="post-img position-relative overflow-hidden">
                                    <img src="/img/worker/home-1.jpg" className="img-fluid" alt="" />
                                ...
                                <div className="post-content d-flex flex-column">
                                    ...
                                    {/* <a href="blog-details.html" className="readmore stretched-link"><span>Read More</span><i className="bi bi-arrow-right" /></a> */}
                                        ...
                                        READ MORE<i className="fa fa-arrow-right ms-3" />
                        ...
                        <div className="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay={200}>
                            <div className="post-item position-relative h-100">
                                <div className="post-img position-relative overflow-hidden">
                                    <img src="/img/worker/home-2.jpg" className="img-fluid" alt="" />
                                    <span className="post-date"> <div>
                                        <span className="fa fa-star checked" />
                                        <span className="fa fa-star checked" />
                                        <span className="fa fa-star checked" />
                        ...
                        <div className="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay={200}>
                            <div className="post-item position-relative h-100">
                                <div className="post-img position-relative overflow-hidden">
                                    <img src="/img/worker/home-3.jpg" className="img-fluid" alt="" />
                                    <span className="post-date"> <div>
                                        <span className="fa fa-star checked" />
                                        <span className="fa fa-star checked" />
                                        <span className="fa fa-star checked" />
                        ...
                        <div className="col-xl-4 col-md-6">
                            <div className="post-item position-relative h-100" data-aos="fade-up" data-aos-delay={300}>
                                <div className="post-img position-relative overflow-hidden">
                                    <img src="/img/worker/home-4.jpg" className="img-fluid" alt="" />
                                    <span className="post-date"> <div>
                                        <span className="fa fa-star checked" />
                                        <span className="fa fa-star checked" />
                                        <span className="fa fa-star checked" />
