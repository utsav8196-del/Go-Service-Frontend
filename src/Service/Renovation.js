                ...
                <div className="container text-center py-5">
                    ...
                    <nav aria-label="breadcrumb animated slideInDown">
                        <ol className="breadcrumb justify-content-center mb-0">
                            ...
                            <li className="breadcrumb-item text-primary active" aria-current="page">Renovation and Painting</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div className="container">
                        <div className="row gy-4 justify-content-center">
                            <div className="col-lg-4">
                                <img src="img/service-3.jpg" className="img-fluid" alt="Bike Repair" />
                            </div>
                            <div className="col-lg-5 content">
                                <h2>Professional Renovation and Painting</h2>
                                ...
                                <div className="row">
                                    <div className="col-lg-6">
                                        <ul>
                                            <li><i className="bi bi-chevron-right" /> <strong>Type:</strong> <span>Renovation and Painting</span></li>
                ...
                <div className="container" data-aos="fade-up">
                    ...
                    <div className="row gy-5">
                        <div className="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay={100}>
                            <div className="post-item position-relative h-100">
                                <div className="post-img position-relative overflow-hidden">
                                    <img src="/img/worker/renovation-1.jpg" className="img-fluid" alt="" />
                        ...
                        <div className="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay={200}>
                            <div className="post-item position-relative h-100">
                                <div className="post-img position-relative overflow-hidden">
                                    <img src="/img/worker/renovation-2.jpeg" className="img-fluid" alt="" />
                                    <span className="post-date"> <div>
                                        <span className="fa fa-star checked" />
                                        <span className="fa fa-star checked" />
                                        <span className="fa fa-star checked" />
                        ...
                        <div className="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay={200}>
                            <div className="post-item position-relative h-100">
                                <div className="post-img position-relative overflow-hidden">
                                    <img src="/img/worker/renovation-3.jpg" className="img-fluid" alt="" />
                                    <span className="post-date"> <div>
                                        <span className="fa fa-star checked" />
                                        <span className="fa fa-star checked" />
                                        <span className="fa fa-star checked" />
                        ...
                        <div className="col-xl-4 col-md-6">
                            <div className="post-item position-relative h-100" data-aos="fade-up" data-aos-delay={300}>
                                <div className="post-img position-relative overflow-hidden">
                                    <img src="/img/worker/renovation-4.jpg" className="img-fluid" alt="" />
                                    <span className="post-date"> <div>
                                        <span className="fa fa-star checked" />
                                        <span className="fa fa-star checked" />
                                        <span className="fa fa-star checked" />
